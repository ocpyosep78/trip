	    ...
	    <div>
			...
			<div class="left">
				<ul class="bcrumbs">
					...
					<li>/</li>	 					
					<li><a href="#" class="active">Hotel Tugu Malang</a></li>					
				</ul>				
			</div>
				...
				<div class="hpadding20">
					...
					<a href="#" class="booknow margtop20 btnmarg">Book now</a>
									...
									<ul class="checkbook">
											...
											<label>
							  <input type="checkbox"> Agoda
							</label>
								<label>
							  <input type="checkbox"> Wego
							</label>
							<label>
							  <input type="checkbox"> Tiket.com
							</label>
							<label>
							  <input type="checkbox"> Pegi-pegi.com
							</label>
							<label>
							  <input type="checkbox"> Hoteltravel.com
							</label>							
									</ul>
