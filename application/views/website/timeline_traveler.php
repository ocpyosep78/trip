...
<section id="content-wrap" class="wrap" role="main"><!-- BEGIN #content-wrap -->
	...
	<div id="content" class="row"><!-- BEGIN #content -->
		<div style="position: relative; overflow: hidden; height: 576px;" id="isotope" class="isotope animated fadeIn"><!-- BEGIN #isotope -->
			<article style="position: absolute; left: 0px; top: 0px;" class="post-66 post type-post status-publish format-gallery hentry category-photography item six columns isotope-item item-right item-left"><!-- BEGIN #post-66 -->
				<span class="indicator-top"></span>
				<div class="post-content"><!-- BEGIN .post-content -->
					<a href="<?php echo $photo['link_traveler_photo']; ?>" title="<?php echo $photo['title']; ?>" rel="bookmark">
						<div class="entry-format entry-gallery"><!-- BEGIN .entry-format -->
							<img src="<?php echo $photo['thumbnail_link']; ?>" alt="flowers-2" height="673" width="602" />
					...
					<div class="entry-content"><!-- BEGIN .entry-content -->
						<p><?php echo get_length_char($photo['content'], 150, ' ...'); ?></p>
