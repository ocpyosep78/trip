	    ...
	    <div>
			...
			<div class="left">
				<ul class="bcrumbs">
					...
					<li>/</li>
                    <li><a href="#">Malang Kab</a></li>
					<li>/</li>
                    <li><a href="#">Air Terjun Coban Rondo</a></li>
					<li>/</li>					
	...
	<div class="container">
		...
		<div class="container mt25 offset-0">
			...
			<div class="col-md-8 pagecontainer2 offset-0">
					...
					<b>	Descripsi mengenai tempat wisata coban rondo dan di potong max 600 karakter... </b>Lorem ipsum dolor sit amet, consectetur adipiscing elit. Nullam auctor aliquam felis, sit amet tempus nibh ullamcorper nec. Maecenas suscipit dolor at blandit congue. Sed adipiscing, odio feugiat pellentesque tincidunt, est leo vestibulum erat, ac pharetra massa justo ac lorem. 
						</p>
						...
						<div class="hpadding20">
						  ...
						  <div style="width:40%;float:right;margin-top:-15px;">
							<select class="form-control mySelectBoxClass margtop10">
								  ...
								  <option selected>Sort Language</option>
