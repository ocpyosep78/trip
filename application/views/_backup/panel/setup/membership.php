						...
						<section class="panel panel-default">
							<div class="panel-body">
								...
								<div class="form-group">
									...
									<input type="text" class="form-control" name="advert_time" data-required="true" />
								</div>
							</div>
						</section>
					</div>
	...
	var param = {
		...
		callback: function() {
			$('#datatable .btn-edit').click(function() {
				...
				Func.ajax({ url: web.base + 'panel/setup/membership/action', param: { action: 'get_by_id', id: record.id }, callback: function(result) {
			...
			$('#datatable .btn-delete').click(function() {
				...
				Func.confirm_delete({
					...
					url: web.base + 'panel/setup/membership/action', callback: function() { dt.reload(); }
				});
			});
		}
	}
