			...
			<section id="content">
				<section class="vbox">
					<section class="scrollable padder">
						...
						<section class="panel panel-default panel-form hide" id="form-page-static">
							<header class="panel-heading font-bold">Page Static Form</header>
							<div class="panel-body">
								<form class="form-horizontal" data-validate="parsley">
									...
									<div class="form-group">
										...
										<div class="col-sm-10">
											<input type="text" name="alias" class="form-control" data-required="true" readonly="readonly" />
										</div>
									</div>
									<div class="form-group">
...
$(document).ready(function() {
	...
	var param = {
		id: 'datatable',
		source: web.base + 'panel/master/page_static/grid',
		...
		callback: function() {
			...
			$('#datatable .btn-delete').click(function() {
				...
				Func.confirm_delete({
					...
					url: web.base + 'panel/master/page_static/action', callback: function() { dt.reload(); }
				});
			});
		}
	}
	...
	// form
	var form = $('#form-page-static form').parsley();
	$('#form-page-static [name="name"]').keyup(function() {
		var value = Func.GetName($(this).val());
		$('#form-page-static [name="alias"]').val(value);
	});
	$('#form-page-static form').submit(function(e) {
		e.preventDefault();
		if (! form.isValid()) {
			return false;
		}
