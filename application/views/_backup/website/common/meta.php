...
<html dir="ltr" class="ltr" lang="en"><head>
	...
	<script type="text/javascript" src="<?php echo base_url('static/theme/shoper/js/jquery-1.js'); ?>"></script>
	<script type="text/javascript" src="<?php echo base_url('static/theme/shoper/js/jquery-ui-1.js'); ?>"></script>
	<script type="text/javascript" src="<?php echo base_url('static/theme/shoper/js/jquery_003.js'); ?>"></script>
	<script type="text/javascript" src="<?php echo base_url('static/theme/shoper/js/common_002.js'); ?>"></script>
	<script type="text/javascript" src="<?php echo base_url('static/theme/shoper/js/common_003.js'); ?>"></script>
	<script type="text/javascript" src="<?php echo base_url('static/theme/shoper/js/bootstrap.js'); ?>"></script>
...
<style id="core-notify" type="text/css">
.notifyjs-corner {
  position: fixed;
  margin: 5px;
  z-index: 1050;
