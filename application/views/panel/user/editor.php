				...
				<section class="vbox">
					<section class="scrollable padder">
						...
						<section class="panel panel-default panel-form hide">
							<header class="panel-heading font-bold">Form Editor</header>
...
$(document).ready(function() {
	...
	var param = {
		id: 'datatable',
		source: web.base + 'panel/user/editor/grid',
		...
		callback: function() {
			$('#datatable .btn-edit').click(function() {
				...
				Func.ajax({ url: web.base + 'panel/user/editor/action', param: { action: 'get_by_id', id: record.id }, callback: function(result) {
			...
			$('#datatable .btn-delete').click(function() {
				...
				Func.confirm_delete({
					...
					url: web.base + 'panel/user/editor/action', callback: function() { dt.reload(); }
				});
			});
		}
	}
	...
	$('.panel-form form').submit(function(e) {
		...
		Func.update({
			link: web.base + 'panel/user/editor/action',
