			...
			<section id="content">
				<section class="vbox">
					<section class="scrollable padder">
						<div class="m-b-md">
							<h3 class="m-b-none">Auto Complete</h3>
						</div>
						...
						<section class="panel panel-default panel-form hide">
							<header class="panel-heading font-bold">Form Auto Complete</header>
							<div class="panel-body">
								<form class="bs-example form-horizontal">
									...
									<div class="form-group">
										...
										<div class="col-lg-10"><select name="category_id" class="form-control">
...
$(document).ready(function() {
	...
	var param = {
		id: 'datatable',
		source: web.base + 'panel/setup/auto_complete/grid',
		...
		callback: function() {
			$('#datatable .btn-edit').click(function() {
				...
				Func.ajax({ url: web.base + 'panel/setup/auto_complete/action', param: { action: 'get_by_id', id: record.id }, callback: function(result) {
			...
			$('#datatable .btn-delete').click(function() {
				...
				Func.confirm_delete({
					...
					url: web.base + 'panel/setup/auto_complete/action', callback: function() { dt.reload(); }
				});
			});
		}
	}
	...
	$('.panel-form form').submit(function(e) {
		...
		Func.update({
			link: web.base + 'panel/setup/auto_complete/action',
