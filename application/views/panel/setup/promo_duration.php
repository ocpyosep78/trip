			...
			<section id="content">
				<section class="vbox">
					<section class="scrollable padder">
						<div class="m-b-md">
							<h3 class="m-b-none">Promo Duration</h3>
						</div>
						...
						<section class="panel panel-default panel-form hide">
							<header class="panel-heading font-bold">Form Promo Duration</header>
							<div class="panel-body">
								<form class="bs-example form-horizontal">
									...
									<div class="form-group">
										...
										<div class="col-lg-10"><input type="text" name="cost" class="form-control" placeholder="Cost" data-required="true" /></div>
									</div>
									<div class="form-group">
										<label class="col-lg-2 control-label">Duration</label>
										<div class="col-lg-10"><input type="text" name="duration" class="form-control" placeholder="Duration" data-required="true" /></div>
									</div>
...
$(document).ready(function() {
	...
	var param = {
		id: 'datatable',
		source: web.base + 'panel/setup/promo_duration/grid',
		...
		callback: function() {
			$('#datatable .btn-edit').click(function() {
				...
				Func.ajax({ url: web.base + 'panel/setup/promo_duration/action', param: { action: 'get_by_id', id: record.id }, callback: function(result) {
			...
			$('#datatable .btn-delete').click(function() {
				...
				Func.confirm_delete({
					...
					url: web.base + 'panel/setup/promo_duration/action', callback: function() { dt.reload(); }
				});
			});
		}
	}
	...
	$('.panel-form form').submit(function(e) {
		...
		Func.update({
			link: web.base + 'panel/setup/promo_duration/action',
