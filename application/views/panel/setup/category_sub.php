...
$(document).ready(function() {
	...
	var param = {
		id: 'datatable',
		source: web.base + 'panel/setup/category_sub/grid',
		...
		callback: function() {
			$('#datatable .btn-edit').click(function() {
				...
				Func.ajax({ url: web.base + 'panel/setup/category_sub/action', param: { action: 'get_by_id', tag_include: true, id: record.id }, callback: function(result) {
			...
			$('#datatable .btn-delete').click(function() {
				...
				Func.confirm_delete({
					...
					url: web.base + 'panel/setup/category_sub/action', callback: function() { dt.reload(); }
				});
			});
		}
	}
	...
	$('.panel-form form').submit(function(e) {
		...
		Func.update({
			link: web.base + 'panel/setup/category_sub/action',
