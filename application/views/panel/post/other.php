...
$(document).ready(function() {
		...
		callback: function() {
			$('#datatable .btn-edit').click(function() {
				...
				Func.ajax({ url: web.base + 'panel/post/other/action', param: { action: 'get_by_id', tag_include: true, id: record.id }, callback: function(result) {
					...
					combo.category_sub({ category_id: result.category_id, target: $('#cnt-form-main [name="category_sub_id"]'), value: result.category_sub_id });
	...
	var facility_param = {
		...
		callback: function() {
			$('#table-facility .btn-delete').click(function() {
				...
				Func.ajax({
					url: web.base + 'panel/post/other/action',
	...
	var gallery_param = {
		...
		callback: function() {
			$('#table-gallery .btn-edit').click(function() {
				...
				Func.ajax({ url: web.base + 'panel/post/other/action', param: { action: 'gallery_get_by_id', id: record.id }, callback: function(result) {
	...
	$('#cnt-form-main [name="category_id"]').change(function(){
		combo.category_sub({ category_id: $(this).val(), target: $('#cnt-form-main [name="category_sub_id"]') });
	});
