	...
	var facility_param = {
		...
		callback: function() {
			$('#table-facility .btn-delete').click(function() {
				...
				Func.ajax({
					url: web.base + 'panel/post/restaurant/action',
	...
	var gallery_param = {
		...
		callback: function() {
			$('#table-gallery .btn-edit').click(function() {
				...
				Func.ajax({ url: web.base + 'panel/post/restaurant/action', param: { action: 'gallery_get_by_id', id: record.id }, callback: function(result) {
