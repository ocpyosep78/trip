			...
			<section id="content">
				<section class="vbox">
					<section class="scrollable padder">
						<div class="m-b-md">
							<h3 class="m-b-none">Destination</h3>
						</div>
	...
	var param = {
		...
		callback: function() {
			$('#datatable .btn-edit').click(function() {
				...
				Func.ajax({ url: web.base + 'panel/post/destination/action', param: { action: 'get_by_id', tag_include: true, id: record.id }, callback: function(result) {
			...
			$('#datatable .btn-delete').click(function() {
				...
				Func.confirm_delete({
					...
					url: web.base + 'panel/post/destination/action', callback: function() { dt.reload(); }
				});
			});
		}
	}
