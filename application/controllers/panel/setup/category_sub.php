<?php
class category_sub extends PANEL_Controller {
    function __construct() {
        parent::__construct();
    }
    
    function index() {
		$this->load->view( 'panel/setup/category_sub' );
    }
	
	function grid() {
		$_POST['is_edit'] = 1;
		$_POST['column'] = array( 'category_title', 'title', 'alias' );
		
		$array = $this->category_sub_model->get_array($_POST);
		$count = $this->category_sub_model->get_count();
